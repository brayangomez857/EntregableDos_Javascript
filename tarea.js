...
const sonIguales = (usuario, numero)=> usuario==numero;
    // Devuelve "true" si "usuario" e "numero" son iguales
    // De lo contrario, devuelve "false"
    // Tu código:
    
    let printMessage = (callbackFunction, usuario, numero) => {
      const esnumeroIgual = callbackFunction(usuario,numero);
      console.log(`el número ${usuario} numero ${numero} son igual? ${esnumeroIgual}`);
  }
...
const crearInstanciaPersona = (nombre, apellido, edad, dir)=>{
  ...
  const Nuevapersona = new Persona(nombre = "Juan", apellido = "Perez", edad = 22, dir = "Saavedra 123");
  return Nuevapersona;
}
